...
function Order() {
  ...
  <div className="shop-item">
    ...
    <div className="shop-item-details">
      ...
      <input type="checkbox" className="btn btn-primary shop-item-button" />
    </div>
  </div>
  <div className="shop-item">
  ...
  <div className="shop-item">
    ...
    <img src="Crusts/Hand tossed round.jpg" />
    <img className="shop-item-image" />
    <div className="shop-item-details">
      <span className="shop-item-price">$1.00</span>
      <input type="checkbox" className="btn btn-primary shop-item-button" />
...
<div className="shop-items">
    ...
    <div className="shop-items">
      ...
      <div className="shop-item">
        ...
        <div className="shop-items">
          ...
          <div className="shop-items">
            <div className="shop-item">
              <span className="shop-item-title eight">Meatballs</span>
              <img src={Meatballs}/>
              <img className="shop-item-image" />
              <div className="shop-item-details">
                <span className="shop-item-price">$.75</span>
            ...
            <div className="shop-item">
              <span className="shop-item-title nine">Sausage</span>
              ...
              <div className="shop-items">
                <div className="shop-item">
                  <span className="shop-item-title ten">Salami</span>
                  <img src="Meats/salami.jpg" />
                  <img className="shop-item-image" />
                  <div className="shop-item-details">
                    <span className="shop-item-price">$.75</span>
                    <input
                ...
                <div className="shop-item">
                  <span className="shop-item-title eleven">Turkey</span>
                  <img src="Meats/Turkey.jpg" />
                  <img className="shop-item-image" />
                  <div className="shop-item-details">
                    <span className="shop-item-price">$.75</span>
                    <input
  ...
  <div className="shop-items">
    <div className="shop-item">
      <span className="shop-item-title twelve">American</span>
      <img src={American} />
      <img className="shop-item-image" />
      <div className="shop-item-details">
        <span className="shop-item-price">$.75</span>
    ...
    <div className="shop-item">
      <span className="shop-item-title thirteen">Cheddar</span>
      <img src={Cheddar} />
      <img className="shop-item-image" />
      <div className="shop-item-details">
        <span className="shop-item-price">$.75</span>
      ...
      <div className="shop-items">
        <div className="shop-item">
          <span className="shop-item-title fourteen">Blue Cheese</span>
        ...
        <div className="shop-item">
          <span className="shop-item-title fifteen">Pepper Jack</span>
          ...
          <div className="shop-items">
            <div className="shop-item">
              <span className="shop-item-title sixteen">Colby</span>
             <img src={Colby}/>
              <img className="shop-item-image" />
              <div className="shop-item-details">
                <span className="shop-item-price">$.75</span>
            ...
            <div className="shop-item">
              <span className="shop-item-title seventeen">Feta</span>
              <img src={feta} />
              <img className="shop-item-image" />
              <div className="shop-item-details">
                <span className="shop-item-price">$1.10</span>
              ...
              <div className="shop-items">
                <div className="shop-item">
                  <span className="shop-item-title eighteen">Smoked Gouda</span>
                ...
                <div className="shop-item">
                  <span className="shop-item-title">Mozerella</span>
                  <img className="whoa" src="Cheese/Mozzarella.jpg" />
                  <img className="shop-item-image" />
                  <div className="shop-item-details">
                    <span className="shop-item-price">$.75</span>
                    <input
                ...
                <div>
  <h2>Select your vegtables/fruit</h2>
  <div className="shop-item">
    <span className="shop-item-title">Avacado</span>
    <img src={Avacado} />
    <img className="shop-item-image" />
    <div className="shop-item-details">
      <span className="shop-item-price">$2.00</span>
      <input type="checkbox" className="btn btn-primary shop-item-button" />
    </div>
  </div>
  <div className="shop-item">
    <span className="shop-item-title">Cherry tomatoes</span>
    <img src="Veg and Fruit/Cherry Tomatoes.jpg" />
    <img className="shop-item-image" />
    <div className="shop-item-details">
      <span className="shop-item-price">$1.05</span>
      <input type="checkbox" className="btn btn-primary shop-item-button" />
    </div>
  </div>
  <div className="shop-item">
    <span className="shop-item-title">Green Pepper </span>
    ...
    <div className="shop-items">
      <div className="shop-item">
        <span className="shop-item-title">Mushrooms</span>
      ...
      <div className="shop-item">
        <span className="shop-item-title">Onions</span>
      ...
      <div className="shop-item">
        <span className="shop-item-title">Olives</span>
        ...
        <div className="shop-items">
          <div className="shop-item">
            <span className="shop-item-title">Peas</span>
          ...
          <div className="shop-item">
            <span className="shop-item-title">Red Beans</span>
          ...
          <div className="shop-item">
            <span className="shop-item-title">Red Pepper</span>
            ...
            <div className="shop-items">
              <div className="shop-item">
                <span className="shop-item-title">Roasted Garlic</span>
              ...
              <div className="shop-item">
                <span className="shop-item-title">Spinach</span>
                ...
                <div className="shop-items">
                  <div className="shop-item">
                    <span className="shop-item-title">Zucchini</span>
                  ...
                  <div className="shop-item">
                    <span className="shop-item-title">Sweet Corn</span>
                  ...
                  <div className="shop-item">
                    <span className="shop-item-title">Pickles</span>
                    ...
                    <div className="shop-items">
                      <div className="shop-item">
                        <span className="shop-item-title">Pinapple</span>
                        ...
                        <h2>Select your Herbs and Spices</h2>
                        <div className="shop-item">
                          <span className="shop-item-title">Basil</span>
                          <img className="shop-item-image" />
                          <div className="shop-item-details">
                            <span className="shop-item-price">$.75</span>
                            <input
                          ...
                          <div className="shop-item">
                            <span className="shop-item-title">Bay Leaf</span>
                            <img className="shop-item-image" />
                            <div className="shop-item-details">
                              <span className="shop-item-price">$.75</span>
                              <input
                            ...
                            <div className="shop-item">
                              <span className="shop-item-title">Chives</span>
                              <img className="shop-item-image" />
                              <div className="shop-item-details">
                                <span className="shop-item-price">$.75</span>
                                <input
                              ...
                              <div className="shop-item">
                                ...
                                <div className="shop-item">
                                  <span className="shop-item-title">Dill</span>
                                  <img className="shop-item-image" />
                                  <div className="shop-item-details">
